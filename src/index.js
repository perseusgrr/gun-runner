...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (localStorage.highScore) {
    document.getElementById(
      "high-score"
    ).innerHTML = `Highscore: ${localStorage.highScore}`;
  }
  ...
  closeColorsMenuBtn.addEventListener("click", () => {
    document
      .getElementById("player-color-select-menu")
      .classList.remove("show");
  });

  const closeControlsMenuBtn = document.getElementById(
    "exit-controls-menu-btn"
  );
