...
class Game {
  ...
  isOutOfBounds(pos) {
    return pos[0] < -50 || pos[1] < 0 || pos[0] > 850 || pos[1] > 300;
  }
  ...
  dash() {
    if (this.dashReady) {
      ...
      document
        .getElementById("boost-bar-inner-green")
        .classList.remove("inner-boost-bar-fill");
      document
        .getElementById("boost-bar-inner-green")
  ...
  animateDashBar() {
    ...
    document
      .getElementById("boost-bar-inner-green")
      .classList.add("inner-boost-bar-fill");
  }
